...
export default function Dashboard(){
    ...
    return(
        ...
        {/* LEFT ZONE */}
        <div className={`${hidesidebar ? 'w-[calc(100%-12%-24px)]' : 'lg:w-[calc(100%-20px-12%-24px)] w-[calc(100%-12%-24px)]'}   text-text dark:text-dark-text-color duration-300`}>
            {/* TOP ZONE */}
            <div className={` flex gap-2 flex-col bg-background dark:bg-dark-second rounded-md px-4 py-4`}>
